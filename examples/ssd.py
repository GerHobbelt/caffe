...
solver_file = os.path.join(caffe_root, 'models/VGGNet/VOC0712/SSD_300x300/solver.prototxt')
finetune_file = os.path.join(caffe_root, 'models/VGGNet/VGG_ILSVRC_16_layers_fc_reduced.caffemodel')
assert(os.path.exists(solver_file))
assert(os.path.exists(finetune_file))
...
solver.net.copy_from(finetune_file)
