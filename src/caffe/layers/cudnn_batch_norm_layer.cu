 ...
 * From
 * https://github.com/hujie-frank/GENet/blob/master/src/caffe/layers/cudnn_batch_norm_layer.cu
 * https://github.com/implus/SKNet/blob/master/src/caffe/layers/cudnn_batch_norm_layer.cu
 */
